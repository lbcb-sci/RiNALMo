...
from rinalmo.data.downstream.translation_efficiency.datamodule import TranslationEffDataModule
...
class TranslationEfficiencyWrapper(pl.LightningModule):
    def __init__(
        self,
        lm_config: str = "giga",
...
def main(args):
    ...
    # Datamodule
    alphabet = Alphabet()
    datamodule = TranslationEffDataModule(
    ...
    if not args.test_only:
        ...
        model = TranslationEfficiencyWrapper.load_from_checkpoint(trainer.checkpoint_callback.best_model_path)
